<html lang="id">
 ...
 <body class="bg-[#F4F8FF] min-h-screen flex flex-col">
  <!-- Header -->
  <header class="bg-white rounded-xl mx-4 sm:mx-6 mt-6 flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 py-3 max-w-5xl w-full self-center">

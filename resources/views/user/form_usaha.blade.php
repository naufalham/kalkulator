...
<main class="flex-grow max-w-7xl mx-auto px-8 sm:px-16 lg:px-24 py-8 w-full pt-32">
    <form autocomplete="off" class="bg-white rounded-xl p-8 max-w-6xl w-full mx-auto space-y-2" novalidate="" method="POST" action="{{ route('export.analisis.usaha') }}">
        ...
        <section>
            ...
            <div class="flex mt-6">
                <button type="button" id="add-field" class="bg-[#F97316] text-white text-sm font-semibold rounded-lg px-4 py-2 hover:bg-[#e06f11] transition-colors mr-2">
                    Tambah Pendapatan
                </button>
            </div>
        ...
        <section>
            ...
            <div class="flex mt-6">
                <button type="button" id="add-field-pengeluaran" class="bg-[#F97316] text-white text-sm font-semibold rounded-lg px-4 py-2 hover:bg-[#e06f11] transition-colors mr-2">
                    Tambah Pengeluaran
                </button>
            </div>
            <div id="dynamic-fields" class="space-y-4">
